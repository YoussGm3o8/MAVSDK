...
[Result](classmavsdk_1_1_action.md#classmavsdk_1_1_action_1adc2e13257ef13de0e7610cf879a0ec51) | [goto_location_relative](#classmavsdk_1_1_action_1ae371a01e6dfe3e442be20c39b5cf59d8) (double latitude_deg, double longitude_deg, float relative_altitude_m, float yaw_deg)const | Move the vehicle to a global position using altitude above home.
[Result](classmavsdk_1_1_action.md#classmavsdk_1_1_action_1adc2e13257ef13de0e7610cf879a0ec51) | [goto_location_relative](#classmavsdk_1_1_action_1a55ed97500bc1168e13d65c4efc4a4feb) (double latitude_deg, double longitude_deg, float relative_altitude_m, float yaw_deg, const [OperationOptions](structmavsdk_1_1_operation_options.md) & options)const | Move the vehicle to a global position using altitude above home.
...
### goto_location_relative() {#classmavsdk_1_1_action_1ae371a01e6dfe3e442be20c39b5cf59d8}
```cpp
Result mavsdk::Action::goto_location_relative(double latitude_deg, double longitude_deg, float relative_altitude_m, float yaw_deg) const
```


Move the vehicle to a global position using altitude above home.

The latitude and longitude are WGS84 degrees. The altitude is in metres relative to the home position. Yaw is in degrees, clockwise from North.
...
### goto_location_relative() {#classmavsdk_1_1_action_1a55ed97500bc1168e13d65c4efc4a4feb}
```cpp
Result mavsdk::Action::goto_location_relative(double latitude_deg, double longitude_deg, float relative_altitude_m, float yaw_deg, const OperationOptions &options) const
```


Move the vehicle to a global position using altitude above home.

The timeout bounds the complete operation, including a required flight mode change and all command retries.
